...
O PRD é o "cérebro" dinâmico e a [[Documentação Semântica|documentação central]] que instrui agentes de inteligência artificial sobre como um projeto de software deve funcionar.
